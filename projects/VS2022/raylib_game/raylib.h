...
RLAPI void DrawTextureRecScaled(Texture2D texture, Rectangle source, Vector2 position, float scale, Color tint);
...
RLAPI Mesh GenMeshCubicmapWithoutFloorAndCeiling(Image cubicmap, Vector3 cubeSize);                               // Generate cubes-based map mesh from image data
